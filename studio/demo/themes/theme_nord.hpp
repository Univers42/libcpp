...
CALLOUT_RULE("tip", fg("#A3BE8C")
                        .bg("#0E1A0E")
                        .border("#A3BE8C")
                        .glyph("\xe2\x9c\x94 ")
                        .has_bg(true))
CALLOUT_RULE("note", fg("#5E81AC")
                         .bg("#0C1220")
                         .border("#5E81AC")
                         .glyph("\xe2\x84\xb9  ")
                         .has_bg(true))
CALLOUT_RULE("warning", fg("#EBCB8B")
                            .bg("#1C1A0C")
                            .border("#EBCB8B")
                            .glyph("\xe2\x9a\xa0  ")
                            .has_bg(true))
CALLOUT_RULE("danger", fg("#BF616A")
                           .bg("#1E0C0E")
                           .border("#BF616A")
                           .glyph("\xe2\x98\xa0  ")
                           .has_bg(true))
CALLOUT_RULE("important", fg("#B48EAD")
                              .bg("#1A0E1C")
                              .border("#B48EAD")
                              .glyph("\xe2\x97\x86 ")
                              .has_bg(true))
CALLOUT_RULE("success", fg("#A3BE8C")
                            .bg("#0C1A0A")
                            .border("#A3BE8C")
                            .glyph("\xe2\x9c\x94 ")
                            .has_bg(true))
CALLOUT_RULE("error", fg("#BF616A")
                          .bg("#200A0C")
                          .border("#BF616A")
                          .glyph("\xe2\x9c\x97 ")
                          .has_bg(true))
CALLOUT_RULE("info", fg("#88C0D0")
                         .bg("#0A161E")
                         .border("#88C0D0")
                         .glyph("\xe2\x84\xb9  ")
                         .has_bg(true))
...
/* ── Table ────────────────────────────────────────────────── */
TABLE_RULE(border_preset(libcpp::BORDER_LIGHT)
               .border_color("#4C566A")
               .header_fg("#88C0D0")
               .header_bg("#2E3440")
