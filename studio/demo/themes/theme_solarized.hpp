...
LIBCPP_THEME_BEGIN(solarized_theme)
    ...
    /* ── Headings ─────────────────────────────────────────────── */
    RULE("h1",
        fg("#FDF6E3").bg("#002B36").border("#CB4B16")
        .bold().center()
    ...
    CALLOUT_RULE("tip",       fg("#859900").bg("#001A00").border("#859900").glyph("\xe2\x9c\x94 ").has_bg(true))
    CALLOUT_RULE("note",      fg("#268BD2").bg("#001828").border("#268BD2").glyph("\xe2\x84\xb9  ").has_bg(true))
    CALLOUT_RULE("warning",   fg("#B58900").bg("#1A1400").border("#B58900").glyph("\xe2\x9a\xa0  ").has_bg(true))
    CALLOUT_RULE("danger",    fg("#DC322F").bg("#1A0404").border("#DC322F").glyph("\xe2\x98\xa0  ").has_bg(true))
    CALLOUT_RULE("important", fg("#D33682").bg("#1A041A").border("#D33682").glyph("\xe2\x97\x86 ").has_bg(true))
    CALLOUT_RULE("success",   fg("#859900").bg("#0A1800").border("#859900").glyph("\xe2\x9c\x94 ").has_bg(true))
    CALLOUT_RULE("error",     fg("#DC322F").bg("#200204").border("#DC322F").glyph("\xe2\x9c\x97 ").has_bg(true))
    CALLOUT_RULE("info",      fg("#2AA198").bg("#001A1A").border("#2AA198").glyph("\xe2\x84\xb9  ").has_bg(true))
    ...
    /* ── Table ────────────────────────────────────────────────── */
    TABLE_RULE(
        border_preset(libcpp::BORDER_DOUBLE)
        .border_color("#073642")
        .header_fg("#CB4B16").header_bg("#002B36").header_font(libcpp::FONT_BOLD)
    ...
    /* ── Section ──────────────────────────────────────────────── */
    RULE("section", fg("#268BD2").border("#073642").bold()
