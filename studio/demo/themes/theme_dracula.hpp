...
CALLOUT_RULE("tip", fg("#50FA7B")
                        .bg("#0C1E12")
                        .border("#50FA7B")
                        .glyph("\xe2\x9c\x94 ")
                        .has_bg(true))
CALLOUT_RULE("note", fg("#8BE9FD")
                         .bg("#0C1223")
                         .border("#8BE9FD")
                         .glyph("\xe2\x84\xb9  ")
                         .has_bg(true))
CALLOUT_RULE("warning", fg("#FFB86C")
                            .bg("#231C0A")
                            .border("#FFB86C")
                            .glyph("\xe2\x9a\xa0  ")
                            .has_bg(true))
CALLOUT_RULE("danger", fg("#FF5555")
                           .bg("#260C0C")
                           .border("#FF5555")
                           .glyph("\xe2\x98\xa0  ")
                           .has_bg(true))
CALLOUT_RULE("important", fg("#FF79C6")
                              .bg("#1F0A1F")
                              .border("#FF79C6")
                              .glyph("\xe2\x97\x86 ")
                              .has_bg(true))
CALLOUT_RULE("success", fg("#50FA7B")
                            .bg("#0A200D")
                            .border("#50FA7B")
                            .glyph("\xe2\x9c\x94 ")
                            .has_bg(true))
CALLOUT_RULE("error", fg("#FF5555")
                          .bg("#280A0A")
                          .border("#FF5555")
                          .glyph("\xe2\x9c\x97 ")
                          .has_bg(true))
CALLOUT_RULE("info", fg("#8BE9FD")
                         .bg("#0A1923")
                         .border("#8BE9FD")
                         .glyph("\xe2\x84\xb9  ")
                         .has_bg(true))
...
/* ── Table ────────────────────────────────────────────────── */
TABLE_RULE(border_preset(libcpp::BORDER_ROUNDED)
               .border_color("#6272A4")
               .header_fg("#FF79C6")
               .header_bg("#282A36")
