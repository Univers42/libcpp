...
CALLOUT_RULE("tip", fg("#A6E22E")
                        .bg("#0E1A06")
                        .border("#A6E22E")
                        .glyph("\xe2\x9c\x94 ")
                        .has_bg(true))
CALLOUT_RULE("note", fg("#66D9EF")
                         .bg("#061A22")
                         .border("#66D9EF")
                         .glyph("\xe2\x84\xb9  ")
                         .has_bg(true))
CALLOUT_RULE("warning", fg("#E6DB74")
                            .bg("#1C1A06")
                            .border("#E6DB74")
                            .glyph("\xe2\x9a\xa0  ")
                            .has_bg(true))
CALLOUT_RULE("danger", fg("#F92672")
                           .bg("#1E0610")
                           .border("#F92672")
                           .glyph("\xe2\x98\xa0  ")
                           .has_bg(true))
CALLOUT_RULE("important", fg("#AE81FF")
                              .bg("#14061E")
                              .border("#AE81FF")
                              .glyph("\xe2\x97\x86 ")
                              .has_bg(true))
CALLOUT_RULE("success", fg("#A6E22E")
                            .bg("#0A1A04")
                            .border("#A6E22E")
                            .glyph("\xe2\x9c\x94 ")
                            .has_bg(true))
CALLOUT_RULE("error", fg("#F92672")
                          .bg("#200408")
                          .border("#F92672")
                          .glyph("\xe2\x9c\x97 ")
                          .has_bg(true))
CALLOUT_RULE("info", fg("#66D9EF")
                         .bg("#04161E")
                         .border("#66D9EF")
                         .glyph("\xe2\x84\xb9  ")
                         .has_bg(true))
...
/* ── Table ────────────────────────────────────────────────── */
TABLE_RULE(border_preset(libcpp::BORDER_HEAVY)
               .border_color("#49483E")
               .header_fg("#F92672")
               .header_bg("#272822")
