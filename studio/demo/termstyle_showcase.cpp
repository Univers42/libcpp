...
int main() {
   ...
   * ══════════════════════════════════════════════════════ */
  {
    ...
    std::cout << ts.section("Section Title",
                            "Body text inside a section block.")
              << std::endl;
  }
   ...
   * ══════════════════════════════════════════════════════ */
  {
    ...
    std::cout << ts.section("Custom Section", "Body with custom width.")
              << std::endl;
  }
   ...
   * ══════════════════════════════════════════════════════ */
  {
    ...
    std::cout << "  HDASH   = " << libcpp::Glyph::HDASH << libcpp::Glyph::HDASH
              << libcpp::Glyph::HDASH << libcpp::Glyph::HDASH << std::endl;
  }
   ...
   * ══════════════════════════════════════════════════════ */
  {
    ...
    Srgb colors[] = {Palette::red(),    Palette::green(),   Palette::blue(),
    ...
    for (int i = 0; i < 9; ++i) {
      std::cout << "  " << colors[i].to_ansi_fg() << libcpp::Glyph::BULLET
                << " " << names[i] << " (" << colors[i].to_hex() << ")"
    ...
    std::cout << "  Gradient: "
              << grad.apply("========== gradient demo ==========") << std::endl;
  }
