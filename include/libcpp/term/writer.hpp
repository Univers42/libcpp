...
class TermWriter {
 public:
  ...
  /* -- named callout ----------------------------------------- */
  TermWriter& callout(const std::string& type, const std::string& l1,
 ...
 private:
  ...
  std::string _render_callout(const ElemStyle& es, const std::string& label,
  ...
  static int _split_pipe(const std::string& line, std::string* out,
                         int max_cols);
