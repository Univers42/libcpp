...
std::string _render_line(const ElemStyle& es, const std::string& content) const;
std::string _render_bg_line(const ElemStyle& es, const std::string& content) const;
std::string _render_bg_blank(const ElemStyle& es) const;
std::string _render_sep(const ElemStyle& es) const;
std::string _render_heading(const ElemStyle& es, const std::string& title) const;
