...
**     CALLOUT_RULE("tip",  fg("#A0E0A0").bg("#0C1E12").border("#3CC864").glyph("✔ "))
**     CALLOUT_RULE("note", fg("#AAC8F0").bg("#0C1223").border("#4682E6").glyph("ℹ  "))
**     WIDTH(72)
**   LIBCPP_THEME_END
**
...
# define RULE(sel, props) \
		_ss[sel].props;

# define CALLOUT_RULE(name, props) \
		_ss["callout." name].props;

# define TABLE_RULE(props) \
		_ss.table().props;
