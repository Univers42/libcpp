...
class Table {
 public:
  ...
  void header3(const std::string& a, const std::string& b,
               const std::string& c);
  void header4(const std::string& a, const std::string& b, const std::string& c,
               const std::string& d);
  void header5(const std::string& a, const std::string& b, const std::string& c,
               const std::string& d, const std::string& e);
  void header6(const std::string& a, const std::string& b, const std::string& c,
               const std::string& d, const std::string& e,
               const std::string& f);
  ...
  void row4(const std::string& a, const std::string& b, const std::string& c,
            const std::string& d);
  void row5(const std::string& a, const std::string& b, const std::string& c,
            const std::string& d, const std::string& e);
  void row6(const std::string& a, const std::string& b, const std::string& c,
 ...
 private:
  ...
  std::string _render_hline(const BoxChars& bc, const char* left,
                            const char* mid, const char* right) const;
  std::string _render_row(const BoxChars& bc, const std::string* cells,
