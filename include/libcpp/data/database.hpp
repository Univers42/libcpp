...
class DbColumn {
 public:
  DbColumn();
  DbColumn(const std::string& name, ColType::Type type = ColType::STRING,
...
class Database {
 public:
  ...
  void add_column(const std::string& name, ColType::Type type = ColType::STRING,
                  Align::Type align = Align::LEFT);
...
std::string export_html(DbTable& table,
