...
/*   Updated: 2026/03/21 20:53:32 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ASSERT_CALLED(suite, spy) \
	(suite).assert_true((spy).was_called(), "spy.was_called()", __FILE__, __LINE__)

# define ASSERT_NOT_CALLED(suite, spy) \
	(suite).assert_false((spy).was_called(), "spy.was_called()", __FILE__, __LINE__)
