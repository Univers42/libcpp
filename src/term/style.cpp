...
ElemStyle::ElemStyle(const Srgb& fg_, const Srgb& bg_, const Srgb& brd_,
                     int font_, Align a, int w, int pl, int pr, int pv, int ml,
                     int sb, int sa, bool use_bg, const std::string& gl,
...
TermStyle::TermStyle()
    : /*         fg                    bg                   border font align w
         pL pR pV mL sB sA  bg?   glyph             sep */
      h1_style(Srgb(255, 220, 240), Srgb(30, 15, 40), Srgb(200, 100, 180),
               FONT_BOLD, ALIGN_CENTER, 60, 3, 3, 1, 0, 1, 1, true,
               Glyph::DIAMOND, Glyph::DOUBLE),
      h2_style(Srgb(110, 190, 255), Srgb(0, 0, 0), Srgb(60, 120, 200),
               FONT_BOLD, ALIGN_LEFT, 60, 1, 1, 0, 0, 1, 0, false,
               Glyph::TRIANGLE, Glyph::HDASH_HVY),
      h3_style(Srgb(120, 220, 160), Srgb(0, 0, 0), Srgb(50, 140, 80), FONT_BOLD,
               ALIGN_LEFT, 60, 1, 1, 0, 0, 1, 0, false, Glyph::BULLET,
               Glyph::DOTTED),
      body_style(Srgb(200, 200, 210), Srgb(0, 0, 0), Srgb(128, 128, 128),
                 FONT_NONE, ALIGN_LEFT, 60, 2, 1, 0, 0, 0, 0, false, "",
                 Glyph::HDASH),
      quote_style(Srgb(160, 170, 180), Srgb(0, 0, 0), Srgb(90, 90, 100),
                  FONT_ITALIC, ALIGN_LEFT, 60, 1, 1, 0, 3, 0, 0, false,
                  Glyph::VBAR, Glyph::HDASH),
      info_style(Srgb(80, 200, 255), Srgb(0, 0, 0), Srgb(60, 120, 160),
                 FONT_NONE, ALIGN_LEFT, 60, 1, 1, 0, 0, 0, 0, false,
                 Glyph::INFO, Glyph::HDASH),
      warn_style(Srgb(255, 200, 50), Srgb(0, 0, 0), Srgb(180, 140, 0),
                 FONT_BOLD, ALIGN_LEFT, 60, 1, 1, 0, 0, 0, 0, false,
                 Glyph::WARN, Glyph::HDASH),
      error_style(Srgb(255, 80, 80), Srgb(0, 0, 0), Srgb(200, 40, 40),
                  FONT_BOLD, ALIGN_LEFT, 60, 1, 1, 0, 0, 0, 0, false,
                  Glyph::CROSS, Glyph::HDASH),
      success_style(Srgb(80, 230, 130), Srgb(0, 0, 0), Srgb(0, 160, 80),
                    FONT_NONE, ALIGN_LEFT, 60, 1, 1, 0, 0, 0, 0, false,
                    Glyph::CHECK, Glyph::HDASH),
      danger_style(Srgb(255, 100, 100), Srgb(0, 0, 0), Srgb(200, 40, 40),
                   FONT_BOLD, ALIGN_LEFT, 60, 1, 1, 0, 0, 0, 0, false,
                   Glyph::SKULL, Glyph::HDASH),
      trace_style(Srgb(170, 140, 220), Srgb(0, 0, 0), Srgb(120, 80, 180),
                  FONT_DIM, ALIGN_LEFT, 60, 1, 1, 0, 0, 0, 0, false,
                  Glyph::CHAIN, Glyph::HDASH),
      sep_style(Srgb(80, 80, 90), Srgb(0, 0, 0), Srgb(80, 80, 90), FONT_DIM,
                ALIGN_LEFT, 60, 0, 0, 0, 0, 0, 0, false, "", Glyph::HDASH),
      section_style(Srgb(130, 200, 255), Srgb(0, 0, 0), Srgb(70, 130, 200),
                    FONT_BOLD, ALIGN_LEFT, 60, 1, 1, 0, 0, 0, 0, false,
                    Glyph::TRIANGLE, Glyph::HDASH_HVY),
      callout_style(Srgb(190, 200, 215), Srgb(20, 25, 38), Srgb(80, 120, 180),
                    FONT_NONE, ALIGN_LEFT, 60, 1, 1, 0, 1, 0, 0, true,
                    Glyph::INFO, Glyph::HDASH),
      bullet_style(Srgb(190, 200, 210), Srgb(0, 0, 0), Srgb(128, 128, 128),
                   FONT_NONE, ALIGN_LEFT, 60, 3, 1, 0, 0, 0, 0, false,
                   Glyph::BULLET, Glyph::HDASH),
      ol_style(Srgb(190, 200, 210), Srgb(0, 0, 0), Srgb(128, 128, 128),
               FONT_NONE, ALIGN_LEFT, 60, 3, 1, 0, 0, 0, 0, false, "",
               Glyph::HDASH),
      bold_style(Srgb(255, 255, 255), Srgb(0, 0, 0), Srgb(128, 128, 128),
                 FONT_BOLD, ALIGN_LEFT, 60, 2, 1, 0, 0, 0, 0, false, "",
                 Glyph::HDASH),
      italic_style(Srgb(200, 200, 220), Srgb(0, 0, 0), Srgb(128, 128, 128),
                   FONT_ITALIC, ALIGN_LEFT, 60, 2, 1, 0, 0, 0, 0, false, "",
                   Glyph::HDASH),
      underline_style(Srgb(200, 200, 220), Srgb(0, 0, 0), Srgb(128, 128, 128),
                      FONT_UNDERLINE, ALIGN_LEFT, 60, 2, 1, 0, 0, 0, 0, false,
                      "", Glyph::HDASH),
      strike_style(Srgb(150, 150, 160), Srgb(0, 0, 0), Srgb(128, 128, 128),
                   FONT_STRIKE, ALIGN_LEFT, 60, 2, 1, 0, 0, 0, 0, false, "",
                   Glyph::HDASH),
      dim_style(Srgb(140, 140, 150), Srgb(0, 0, 0), Srgb(128, 128, 128),
                FONT_DIM, ALIGN_LEFT, 60, 2, 1, 0, 0, 0, 0, false, "",
                Glyph::HDASH),
      code_style(Srgb(230, 180, 100), Srgb(30, 30, 40), Srgb(128, 128, 128),
                 FONT_NONE, ALIGN_LEFT, 60, 2, 1, 0, 0, 0, 0, true, "",
                 Glyph::HDASH) {}
...
TermStyle::TermStyle(const TermStyle& o)
    : h1_style(o.h1_style),
      ...
      quote_style(o.quote_style),
      info_style(o.info_style),
      warn_style(o.warn_style),
      error_style(o.error_style),
      success_style(o.success_style),
      danger_style(o.danger_style),
      trace_style(o.trace_style),
      sep_style(o.sep_style),
      section_style(o.section_style),
      callout_style(o.callout_style),
      bullet_style(o.bullet_style),
      ol_style(o.ol_style),
      bold_style(o.bold_style),
      italic_style(o.italic_style),
      underline_style(o.underline_style),
      strike_style(o.strike_style),
      dim_style(o.dim_style),
...
std::string TermStyle::_align_text(const std::string& txt, int available,
                                   Align a) const {
...
std::string TermStyle::_render_line(const ElemStyle& es,
...
std::string TermStyle::_render_bg_line(const ElemStyle& es,
                                       const std::string& content) const {
  std::string r;
  int w = es.width > 0 ? es.width : 60;
  int inner_w = w - es.pad_l - es.pad_r;
...
std::string TermStyle::_render_heading(const ElemStyle& es,
  ...
  if (es.has_bg) {
    ...
    */
    ...
    inner.space_after = 0;
    r += _render_sep(es) + "\n";
    for (int i = 0; i < es.pad_v; ++i) r += _render_bg_blank(es) + "\n";
...
std::string TermStyle::_apply_inline(int font, const std::string& t) const {
  return TermUtils::apply_fg(body_style.fg) + TermUtils::apply_font(font) + t +
         TermUtils::reset();
}
...
std::string TermStyle::h1(const std::string& t) const {
  return _render_heading(h1_style, t);
}
...
std::string TermStyle::text(const std::string& msg) const {
  return _render_line(body_style, msg);
}

std::string TermStyle::bold(const std::string& msg) const {
  return _render_line(bold_style, msg);
}
std::string TermStyle::italic(const std::string& msg) const {
  return _render_line(italic_style, msg);
}
std::string TermStyle::dim(const std::string& msg) const {
  return _render_line(dim_style, msg);
}
std::string TermStyle::underline(const std::string& msg) const {
  return _render_line(underline_style, msg);
}
std::string TermStyle::strike(const std::string& msg) const {
  return _render_line(strike_style, msg);
}
std::string TermStyle::code(const std::string& msg) const {
  return _render_line(code_style, msg);
}
...
std::string TermStyle::quote(const std::string& msg) const {
  return _render_line(quote_style, msg);
}
...
std::string TermStyle::callout(const std::string& label, const std::string& l1,
  ...
  const std::string* lines[10] = {&l1, &l2, &l3, &l4, &l5,
                                  &l6, &l7, &l8, &l9, &l10};
  int line_count = 0;
  for (int i = 0; i < 10; ++i)
...
TermConf::TermConf()
    : global_width(60),
      ...
      h1_fg(220, 160, 255),
      h1_border(160, 100, 220),
      h2_fg(130, 200, 255),
      h2_border(70, 130, 200),
      h3_fg(180, 220, 180),
      h3_border(80, 140, 80),
...
TermConf::TermConf(const TermConf& o)
    : global_width(o.global_width),
      h1_space_before(o.h1_space_before),
      h1_space_after(o.h1_space_after),
      h2_space_before(o.h2_space_before),
      h2_space_after(o.h2_space_after),
      h3_space_before(o.h3_space_before),
      h3_space_after(o.h3_space_after),
      log_space_before(o.log_space_before),
      log_space_after(o.log_space_after),
      sep_space_before(o.sep_space_before),
      sep_space_after(o.sep_space_after),
      quote_space_before(o.quote_space_before),
      quote_space_after(o.quote_space_after),
      section_space_before(o.section_space_before),
      section_space_after(o.section_space_after),
      text_space_before(o.text_space_before),
      text_space_after(o.text_space_after),
      h1_fg(o.h1_fg),
      h1_border(o.h1_border),
      h2_fg(o.h2_fg),
      h2_border(o.h2_border),
      h3_fg(o.h3_fg),
      h3_border(o.h3_border),
      h1_font(o.h1_font),
      h2_font(o.h2_font),
      h3_font(o.h3_font),
      h1_glyph(o.h1_glyph),
      ...
      warn_fg(o.warn_fg),
      error_fg(o.error_fg),
      success_fg(o.success_fg),
      danger_fg(o.danger_fg),
      trace_fg(o.trace_fg),
      info_glyph(o.info_glyph),
      warn_glyph(o.warn_glyph),
      error_glyph(o.error_glyph),
      success_glyph(o.success_glyph),
      danger_glyph(o.danger_glyph),
      trace_glyph(o.trace_glyph),
      quote_fg(o.quote_fg),
      quote_glyph(o.quote_glyph),
      quote_margin(o.quote_margin),
      sep_border(o.sep_border),
      sep_str(o.sep_str),
      text_fg(o.text_fg),
      bullet_fg(o.bullet_fg),
      bullet_glyph(o.bullet_glyph),
      ol_fg(o.ol_fg),
      callout_fg(o.callout_fg),
      callout_bg(o.callout_bg),
      callout_border(o.callout_border),
      callout_glyph(o.callout_glyph),
      callout_body_glyph(o.callout_body_glyph),
      callout_has_bg(o.callout_has_bg),
      h1_bg(o.h1_bg),
      h1_has_bg(o.h1_has_bg),
      h1_pad_v(o.h1_pad_v) {}
...
void TermConf::apply(TermStyle& ts) const {
  /* h1 */
  ts.h1_style.fg = h1_fg;
  ts.h1_style.bg = h1_bg;
  ts.h1_style.border = h1_border;
  ts.h1_style.font = h1_font;
  ts.h1_style.align = h1_align;
  ts.h1_style.width = global_width;
  ts.h1_style.glyph = h1_glyph;
  ts.h1_style.sep_str = h1_sep;
  ts.h1_style.space_before = h1_space_before;
  ts.h1_style.space_after = h1_space_after;
  ts.h1_style.has_bg = h1_has_bg;
  ts.h1_style.pad_v = h1_pad_v;
  /* h2 */
  ts.h2_style.fg = h2_fg;
  ts.h2_style.border = h2_border;
  ts.h2_style.font = h2_font;
  ts.h2_style.align = h2_align;
  ts.h2_style.width = global_width;
  ts.h2_style.glyph = h2_glyph;
  ts.h2_style.sep_str = h2_sep;
  ts.h2_style.space_before = h2_space_before;
  ts.h2_style.space_after = h2_space_after;
  /* h3 */
  ts.h3_style.fg = h3_fg;
  ts.h3_style.border = h3_border;
  ts.h3_style.font = h3_font;
  ts.h3_style.align = h3_align;
  ts.h3_style.width = global_width;
  ts.h3_style.glyph = h3_glyph;
  ts.h3_style.sep_str = h3_sep;
  ts.h3_style.space_before = h3_space_before;
  ts.h3_style.space_after = h3_space_after;
  /* text */
  ts.body_style.fg = text_fg;
  ts.body_style.width = global_width;
  ts.body_style.space_before = text_space_before;
  ts.body_style.space_after = text_space_after;
  /* info */
  ts.info_style.fg = info_fg;
  ts.info_style.glyph = info_glyph;
  ts.info_style.width = global_width;
  ts.info_style.space_before = log_space_before;
  ts.info_style.space_after = log_space_after;
  /* warn */
  ts.warn_style.fg = warn_fg;
  ts.warn_style.glyph = warn_glyph;
  ts.warn_style.width = global_width;
  ts.warn_style.space_before = log_space_before;
  ts.warn_style.space_after = log_space_after;
  /* error */
  ts.error_style.fg = error_fg;
  ts.error_style.glyph = error_glyph;
  ts.error_style.width = global_width;
  ts.error_style.space_before = log_space_before;
  ts.error_style.space_after = log_space_after;
  /* success */
  ts.success_style.fg = success_fg;
  ts.success_style.glyph = success_glyph;
  ts.success_style.width = global_width;
  ts.success_style.space_before = log_space_before;
  ts.success_style.space_after = log_space_after;
  /* danger */
  ts.danger_style.fg = danger_fg;
  ts.danger_style.glyph = danger_glyph;
  ts.danger_style.width = global_width;
  ts.danger_style.space_before = log_space_before;
  ts.danger_style.space_after = log_space_after;
  /* trace */
  ts.trace_style.fg = trace_fg;
  ts.trace_style.glyph = trace_glyph;
  ts.trace_style.width = global_width;
  ts.trace_style.space_before = log_space_before;
  ts.trace_style.space_after = log_space_after;
  /* quote */
  ts.quote_style.fg = quote_fg;
  ts.quote_style.glyph = quote_glyph;
  ts.quote_style.width = global_width;
  ts.quote_style.margin_l = quote_margin;
  ts.quote_style.space_before = quote_space_before;
  ts.quote_style.space_after = quote_space_after;
  /* separator */
  ts.sep_style.border = sep_border;
  ts.sep_style.sep_str = sep_str;
  ts.sep_style.width = global_width;
  ts.sep_style.space_before = sep_space_before;
  ts.sep_style.space_after = sep_space_after;
  /* bullet list */
  ts.bullet_style.fg = bullet_fg;
  ts.bullet_style.glyph = bullet_glyph;
  ts.bullet_style.width = global_width;
  /* ordered list */
  ts.ol_style.fg = ol_fg;
  ts.ol_style.width = global_width;
  /* callout */
  ts.callout_style.fg = callout_fg;
  ts.callout_style.bg = callout_bg;
  ts.callout_style.border = callout_border;
  ts.callout_style.glyph = callout_glyph;
  ts.callout_style.body_glyph = callout_body_glyph;
  ts.callout_style.has_bg = callout_has_bg;
  ts.callout_style.width = global_width;
}
...
void TermConf::apply_minimal(TermStyle& ts) {
  ...
  c.h2_space_before = 0;
  c.h2_space_after = 0;
  c.section_space_before = 0;
  c.section_space_after = 0;
  c.h1_font = FONT_BOLD;
  c.h2_font = FONT_BOLD;
  c.h3_font = FONT_NONE;
  c.h1_glyph = Glyph::TRIANGLE;
  c.h2_glyph = Glyph::BULLET;
  c.h3_glyph = "";
  c.h1_sep = Glyph::HDASH;
  c.h2_sep = Glyph::HDASH;
  c.h3_sep = "";
  c.h1_fg = Srgb(200, 200, 200);
  c.h1_border = Srgb(120, 120, 120);
  c.h2_fg = Srgb(180, 180, 180);
  c.h2_border = Srgb(100, 100, 100);
  c.apply(ts);
}
...
void TermConf::apply_compact(TermStyle& ts) {
  ...
  c.h3_space_before = 0;
  c.h3_space_after = 0;
  c.log_space_before = 0;
  c.log_space_after = 0;
  c.sep_space_before = 0;
  c.sep_space_after = 0;
  c.section_space_before = 0;
  c.section_space_after = 0;
  c.apply(ts);
...
void TermConf::apply_wide(TermStyle& ts) {
  ...
  c.h3_space_before = 1;
  c.h3_space_after = 0;
  c.section_space_before = 1;
  c.section_space_after = 1;
  c.h1_fg = Srgb(255, 200, 100);
  c.h1_border = Srgb(200, 150, 50);
  c.h1_sep = Glyph::HDASH_HVY;
  c.h2_sep = Glyph::DOUBLE;
  c.apply(ts);
}
