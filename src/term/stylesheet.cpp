...
TableRule::TableRule()
    : _set(0),
      _border(BORDER_LIGHT),
      _border_color(100, 100, 110),
      _header_fg(255, 255, 255),
      _header_bg(40, 44, 52),
      _header_font(FONT_BOLD),
      _header_has_bg(false),
      _show_header(true),
      _header_sep(true),
      _cell_fg(200, 200, 210),
      _cell_bg(0, 0, 0),
      _cell_alt_bg(22, 24, 30),
      _zebra(false),
      _cell_has_bg(false),
      _title_fg(255, 255, 255),
      _title_bg(40, 44, 52),
      _title_font(FONT_BOLD),
      _title_has_bg(false),
      _footer_fg(140, 140, 150),
      _footer_font(FONT_DIM),
      _pad(1),
      _outer_margin(0),
      _max_col_width(0),
      _show_row_nums(false),
      _row_separator(false),
      _compact(false),
      _focus_fg(255, 255, 255),
      _focus_bg(60, 60, 80),
      _focus_font(FONT_BOLD) {}
...
TableRule::TableRule(const TableRule& o)
    : _set(o._set),
      ...
      _header_fg(o._header_fg),
      _header_bg(o._header_bg),
      _header_font(o._header_font),
      _header_has_bg(o._header_has_bg),
      _show_header(o._show_header),
      _header_sep(o._header_sep),
      _cell_fg(o._cell_fg),
      _cell_bg(o._cell_bg),
      _cell_alt_bg(o._cell_alt_bg),
      _zebra(o._zebra),
      _cell_has_bg(o._cell_has_bg),
      _title_fg(o._title_fg),
      _title_bg(o._title_bg),
      _title_font(o._title_font),
      _title_has_bg(o._title_has_bg),
      _footer_fg(o._footer_fg),
      _footer_font(o._footer_font),
      _pad(o._pad),
      _outer_margin(o._outer_margin),
      _max_col_width(o._max_col_width),
      _show_row_nums(o._show_row_nums),
      _row_separator(o._row_separator),
      _compact(o._compact),
      _focus_fg(o._focus_fg),
      _focus_bg(o._focus_bg),
...
/* ── border ───────────────────────────────────────────────────────────── */
TableRule& TableRule::border_preset(BorderPreset bp) {
  _border = bp;
  _set |= T_BORDER_PRESET;
  return *this;
}
TableRule& TableRule::border_color(const std::string& hex) {
  _border_color = Srgb::from_hex(hex);
  _set |= T_BORDER_COLOR;
  return *this;
}
TableRule& TableRule::border_color(const Srgb& c) {
  _border_color = c;
  _set |= T_BORDER_COLOR;
  return *this;
}
...
/* ── header ───────────────────────────────────────────────────────────── */
TableRule& TableRule::header_fg(const std::string& hex) {
  _header_fg = Srgb::from_hex(hex);
  _set |= T_HEADER_FG;
  return *this;
}
TableRule& TableRule::header_fg(const Srgb& c) {
  _header_fg = c;
  _set |= T_HEADER_FG;
  return *this;
}
TableRule& TableRule::header_bg(const std::string& hex) {
  _header_bg = Srgb::from_hex(hex);
  _set |= T_HEADER_BG | T_HEADER_HAS_BG;
  _header_has_bg = true;
  return *this;
}
TableRule& TableRule::header_bg(const Srgb& c) {
  _header_bg = c;
  _set |= T_HEADER_BG | T_HEADER_HAS_BG;
  _header_has_bg = true;
  return *this;
}
TableRule& TableRule::header_font(int f) {
  _header_font = f;
  _set |= T_HEADER_FONT;
  return *this;
}
TableRule& TableRule::header_has_bg(bool v) {
  _header_has_bg = v;
  _set |= T_HEADER_HAS_BG;
  return *this;
}
TableRule& TableRule::show_header(bool v) {
  _show_header = v;
  _set |= T_SHOW_HEADER;
  return *this;
}
TableRule& TableRule::header_separator(bool v) {
  _header_sep = v;
  _set |= T_HEADER_SEP;
  return *this;
}
...
/* ── cells ────────────────────────────────────────────────────────────── */
TableRule& TableRule::cell_fg(const std::string& hex) {
  _cell_fg = Srgb::from_hex(hex);
  _set |= T_CELL_FG;
  return *this;
}
TableRule& TableRule::cell_fg(const Srgb& c) {
  _cell_fg = c;
  _set |= T_CELL_FG;
  return *this;
}
TableRule& TableRule::cell_bg(const std::string& hex) {
  _cell_bg = Srgb::from_hex(hex);
  _set |= T_CELL_BG | T_CELL_HAS_BG;
  _cell_has_bg = true;
  return *this;
}
TableRule& TableRule::cell_bg(const Srgb& c) {
  _cell_bg = c;
  _set |= T_CELL_BG | T_CELL_HAS_BG;
  _cell_has_bg = true;
  return *this;
}
TableRule& TableRule::cell_alt_bg(const std::string& hex) {
  _cell_alt_bg = Srgb::from_hex(hex);
  _set |= T_CELL_ALT_BG;
  return *this;
}
TableRule& TableRule::cell_alt_bg(const Srgb& c) {
  _cell_alt_bg = c;
  _set |= T_CELL_ALT_BG;
  return *this;
}
TableRule& TableRule::zebra(bool v) {
  _zebra = v;
  _set |= T_ZEBRA;
  return *this;
}
TableRule& TableRule::cell_has_bg(bool v) {
  _cell_has_bg = v;
  _set |= T_CELL_HAS_BG;
  return *this;
}
...
/* ── title& footer ───────────────────────────────────────────────────── */
TableRule& TableRule::title_fg(const std::string& hex) {
  _title_fg = Srgb::from_hex(hex);
  _set |= T_TITLE_FG;
  return *this;
}
TableRule& TableRule::title_fg(const Srgb& c) {
  _title_fg = c;
  _set |= T_TITLE_FG;
  return *this;
}
TableRule& TableRule::title_bg(const std::string& hex) {
  _title_bg = Srgb::from_hex(hex);
  _set |= T_TITLE_BG | T_TITLE_HAS_BG;
  _title_has_bg = true;
  return *this;
}
TableRule& TableRule::title_bg(const Srgb& c) {
  _title_bg = c;
  _set |= T_TITLE_BG | T_TITLE_HAS_BG;
  _title_has_bg = true;
  return *this;
}
TableRule& TableRule::title_font(int f) {
  _title_font = f;
  _set |= T_TITLE_FONT;
  return *this;
}
TableRule& TableRule::title_has_bg(bool v) {
  _title_has_bg = v;
  _set |= T_TITLE_HAS_BG;
  return *this;
}
TableRule& TableRule::footer_fg(const std::string& hex) {
  _footer_fg = Srgb::from_hex(hex);
  _set |= T_FOOTER_FG;
  return *this;
}
TableRule& TableRule::footer_fg(const Srgb& c) {
  _footer_fg = c;
  _set |= T_FOOTER_FG;
  return *this;
}
TableRule& TableRule::footer_font(int f) {
  _footer_font = f;
  _set |= T_FOOTER_FONT;
  return *this;
}
...
/* ── layout ───────────────────────────────────────────────────────────── */
TableRule& TableRule::pad(int p) {
  _pad = p;
  _set |= T_PAD;
  return *this;
}
TableRule& TableRule::outer_margin(int m) {
  _outer_margin = m;
  _set |= T_OUTER_MARGIN;
  return *this;
}
TableRule& TableRule::max_col_width(int w) {
  _max_col_width = w;
  _set |= T_MAX_COL_WIDTH;
  return *this;
}
TableRule& TableRule::show_row_numbers(bool v) {
  _show_row_nums = v;
  _set |= T_SHOW_ROW_NUMS;
  return *this;
}
TableRule& TableRule::row_separator(bool v) {
  _row_separator = v;
  _set |= T_ROW_SEPARATOR;
  return *this;
}
TableRule& TableRule::compact(bool v) {
  _compact = v;
  _set |= T_COMPACT;
  return *this;
}
...
/* ── focus style ──────────────────────────────────────────────────────── */
TableRule& TableRule::focus_fg(const std::string& hex) {
  _focus_fg = Srgb::from_hex(hex);
  _set |= T_FOCUS_FG;
  return *this;
}
TableRule& TableRule::focus_fg(const Srgb& c) {
  _focus_fg = c;
  _set |= T_FOCUS_FG;
  return *this;
}
TableRule& TableRule::focus_bg(const std::string& hex) {
  _focus_bg = Srgb::from_hex(hex);
  _set |= T_FOCUS_BG;
  return *this;
}
TableRule& TableRule::focus_bg(const Srgb& c) {
  _focus_bg = c;
  _set |= T_FOCUS_BG;
  return *this;
}
TableRule& TableRule::focus_font(int f) {
  _focus_font = f;
  _set |= T_FOCUS_FONT;
  return *this;
}
...
/* ── presets ──────────────────────────────────────────────────────────── */
TableRule& TableRule::preset_minimal() {
  _base = TableStyle::minimal();
  _set |= T_PRESET;
  return *this;
}
TableRule& TableRule::preset_modern() {
  _base = TableStyle::modern();
  _set |= T_PRESET;
  return *this;
}
TableRule& TableRule::preset_heavy() {
  _base = TableStyle::heavy_style();
  _set |= T_PRESET;
  return *this;
}
TableRule& TableRule::preset_matrix() {
  _base = TableStyle::matrix();
  _set |= T_PRESET;
  return *this;
}
TableRule& TableRule::preset_postman() {
  _base = TableStyle::postman();
  _set |= T_PRESET;
  return *this;
}
...
void TableRule::apply_to(TableStyle& ts) const {
  ...
  if (_set & T_FOCUS_FG) {
    ts.focus_style.fg = _focus_fg;
    ts.focus_style.has_fg = true;
  }
  if (_set & T_FOCUS_BG) {
    ts.focus_style.bg = _focus_bg;
    ts.focus_style.has_bg = true;
  }
  if (_set & T_FOCUS_FONT) {
    ts.focus_style.font = _focus_font;
    ts.focus_style.has_font = true;
  }
}
...
Rule::Rule(const Rule& o)
    : _set(o._set),
      ...
      _pad_r(o._pad_r),
      _pad_v(o._pad_v),
      _margin_l(o._margin_l),
      _space_before(o._space_before),
      _space_after(o._space_after),
      _has_bg(o._has_bg),
      _glyph(o._glyph),
      _body_glyph(o._body_glyph),
      _sep(o._sep) {}
...
Rule& Rule::fg(const std::string& hex) {
  _fg = Srgb::from_hex(hex);
  _set |= P_FG;
  return *this;
}
Rule& Rule::fg(const Srgb& c) {
  _fg = c;
  _set |= P_FG;
  return *this;
}
Rule& Rule::bg(const std::string& hex) {
  _bg = Srgb::from_hex(hex);
  _set |= P_BG | P_HAS_BG;
  _has_bg = true;
  return *this;
}
Rule& Rule::bg(const Srgb& c) {
  _bg = c;
  _set |= P_BG | P_HAS_BG;
  _has_bg = true;
  return *this;
}
Rule& Rule::border(const std::string& hex) {
  _border = Srgb::from_hex(hex);
  _set |= P_BORDER;
  return *this;
}
Rule& Rule::border(const Srgb& c) {
  _border = c;
  _set |= P_BORDER;
  return *this;
}
...
Rule& Rule::width(int w) {
  _width = w;
  _set |= P_WIDTH;
  return *this;
}
Rule& Rule::pad(int l, int r) {
  _pad_l = l;
  _pad_r = r;
  _set |= P_PAD_L | P_PAD_R;
  return *this;
}
Rule& Rule::pad(int l, int r, int v) {
  _pad_l = l;
  _pad_r = r;
  _pad_v = v;
  _set |= P_PAD_L | P_PAD_R | P_PAD_V;
  return *this;
}
Rule& Rule::pad_left(int n) {
  _pad_l = n;
  _set |= P_PAD_L;
  return *this;
}
Rule& Rule::pad_right(int n) {
  _pad_r = n;
  _set |= P_PAD_R;
  return *this;
}
Rule& Rule::pad_vert(int n) {
  _pad_v = n;
  _set |= P_PAD_V;
  return *this;
}
Rule& Rule::margin_left(int n) {
  _margin_l = n;
  _set |= P_MARGIN_L;
  return *this;
}
Rule& Rule::spacing(int b, int a) {
  _space_before = b;
  _space_after = a;
  _set |= P_SPACE_B | P_SPACE_A;
  return *this;
}
Rule& Rule::space_before(int n) {
  _space_before = n;
  _set |= P_SPACE_B;
  return *this;
}
Rule& Rule::space_after(int n) {
  _space_after = n;
  _set |= P_SPACE_A;
  return *this;
}
...
Rule& Rule::glyph(const std::string& g) {
  _glyph = g;
  _set |= P_GLYPH;
  return *this;
}
Rule& Rule::body_glyph(const std::string& g) {
  _body_glyph = g;
  _set |= P_BODY_GLYPH;
  return *this;
}
Rule& Rule::sep(const std::string& s) {
  _sep = s;
  _set |= P_SEP;
  return *this;
}
Rule& Rule::has_bg(bool v) {
  _has_bg = v;
  _set |= P_HAS_BG;
  return *this;
}
...
StyleSheet::StyleSheet(const StyleSheet& o)
  ...
  for (int i = 0; i < _rule_count; ++i) _rules[i] = o._rules[i];
}
...
Rule& StyleSheet::operator[](const std::string& selector) {
  ...
  for (int i = 0; i < _rule_count; ++i) {
    if (_rules[i].name == selector) return _rules[i].rule;
  }
  /* create new */
...
const Rule* StyleSheet::_find(const std::string& name) const {
  for (int i = 0; i < _rule_count; ++i)
    if (_rules[i].name == name) return &_rules[i].rule;
  return 0;
}
...
void StyleSheet::apply_table(TermWriter& w) const {
  if (_table_rule.has_values()) _table_rule.apply_to(w.table_style());
}
