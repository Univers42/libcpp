...
/*   Updated: 2026/03/21 20:50:53 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this != &o) { message = o.message; file = o.file; line = o.line; }
	return *this;
}
...
TestCase::TestCase(const std::string& n, TestFn f, bool s) : name(n), fn(f), skip(s) {}
TestCase::TestCase(const TestCase& o) : name(o.name), fn(o.fn), skip(o.skip) {}
TestCase& TestCase::operator=(const TestCase& o)
{
	if (this != &o) { name = o.name; fn = o.fn; skip = o.skip; }
	return *this;
}
TestCase::~TestCase() {}
...
TestResult::TestResult(const TestResult& o)
	: name(o.name), passed(o.passed), skipped(o.skipped),
	  error_msg(o.error_msg), elapsed_ms(o.elapsed_ms) {}
...
{
	if (_test_count < MAX_TESTS)
		_tests[_test_count++] = TestCase(name, fn, true);
	return *this;
}
...
void TestSuite::assert_true(bool cond, const char* expr, const char* file, int line)
{
	if (!cond)
	{
...
void TestSuite::assert_false(bool cond, const char* expr, const char* file, int line)
{
	if (cond)
	{
...
void TestSuite::_print_summary() const
{
	...
	std::cout << "  " << green.to_ansi_fg() << _passed << " passed" << TermUtils::reset();
	if (_failed > 0)
		std::cout << "  " << red.to_ansi_fg() << _failed << " failed" << TermUtils::reset();
	if (_skipped > 0)
		std::cout << "  " << yellow.to_ansi_fg() << _skipped << " skipped" << TermUtils::reset();
