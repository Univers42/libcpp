...
IVector3 IVector3::operator+(const IVector3& rhs) const {
...
IVector3 IVector3::operator/(int s) const {
  if (s == 0) throw std::runtime_error("IVector3: division by zero");
  return {x / s, y / s, z / s};
}
