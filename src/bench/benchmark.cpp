...
/*   Updated: 2026/03/21 20:55:20 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
BenchResult::BenchResult()
	: iterations(0), total_ms(0), mean_ms(0), min_ms(0), max_ms(0), ops_per_sec(0) {}

BenchResult::BenchResult(const BenchResult& o)
	: name(o.name), iterations(o.iterations), total_ms(o.total_ms),
	  mean_ms(o.mean_ms), min_ms(o.min_ms), max_ms(o.max_ms),
...
Benchmark::Benchmark()
	: _name("Benchmark"), _case_count(0), _result_count(0),
	  _warmup(3), _iterations(100) {}

Benchmark::Benchmark(const std::string& name)
	: _name(name), _case_count(0), _result_count(0),
	  _warmup(3), _iterations(100) {}

Benchmark::Benchmark(const Benchmark& o)
	: _name(o._name), _case_count(o._case_count), _result_count(o._result_count),
	  _warmup(o._warmup), _iterations(o._iterations)
{
...
{
	if (_case_count < MAX_CASES)
		_cases[_case_count++] = BenchCase(name, fn);
	return *this;
}

Benchmark& Benchmark::warmup(int n) { _warmup = n; return *this; }
Benchmark& Benchmark::iterations(int n) { _iterations = n; return *this; }
